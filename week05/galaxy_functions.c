// COMP1511 24T1 Tutorial 05 - galaxy_functions.c
//
...
// This demonstrates the use of functions to refactor a large program.
...
// Initialize the galaxy to be empty with 0 points
void initialize_galaxy(struct celestial_body galaxy[SIZE][SIZE]) {
    int row = 0;
    int col = 0;
    while (row < SIZE) {
...
// Scan and place player at specified coordinates
void place_player(struct celestial_body galaxy[SIZE][SIZE]) {
...
// Scan and place planets and nebulae at specified coordinates
void place_planets(struct celestial_body galaxy[SIZE][SIZE]) {
...
// Scan and place stars at specified coordinates
void place_stars(struct celestial_body galaxy[SIZE][SIZE]) {
